...
import Travel from '../assets/projects/travelmaps.png'
...
export const data = [
  ...
  },
  {
    ...
    title: 'Travel Maps',
    description:
      'Google Map implementation with Rapid API travlel and weather data! Lots of cool and complex features in a  React web app thats super easy to use',
    img: Travel,
    url: 'https://travelmapsdan.netlify.app/'
  }
]
